    ...
    (cl-loop for (buf . ovs) in context-alist
             ...
             (unless (bobp)
               ...
               (insert "CONTEXT USAGE AND RULES:\n\n"
                       ...
                       "- Always use the path from `<file_path>` exactly as it is written. Never expand the shortcut `~` or otherwise alter the path; pass it directly to tools for execution.\n"
