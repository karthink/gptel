...
(transient-define-infix gptel--infix-model ()
  ...
  :key "m"
  :choices '("gpt-3.5-turbo-0301" "gpt-3.5-turbo-0613" "gpt-3.5-turbo-16k" "gpt-3.5-turbo" "gpt-4")
  :reader (lambda (prompt &rest _)
            (completing-read
             prompt
             '("gpt-3.5-turbo-0301" "gpt-3.5-turbo-0613" "gpt-3.5-turbo-16k" "gpt-3.5-turbo" "gpt-4"))))
