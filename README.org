...
|------------------+---------------------------------------------------------------------------|
| *To add context* | Will be sent with each request. (Also available from the Transient menu)  |
|------------------+---------------------------------------------------------------------------|
| =gptel-add=      | Add a region or buffer to gptel's context.  Add marked files if in Dired. |
