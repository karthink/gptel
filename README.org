...
Users who pay for below plans can use relative end-points. 

See the annoucement [[https://github.blog/changelog/2026-02-13-network-configuration-changes-for-copilot-coding-agent/#whats-changing][Copilot plan changes]]
...
Custom endpoints can be configure like so -
